========================================================================
    ACTIVE TEMPLATE LIBRARY : RenderCom Project Overview
========================================================================

AppWizard has created this RenderCom project for you to use as the starting point for
...
RenderCom.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (RenderCom.h)
        GUID definitions                                (RenderCom_i.c)
        A type library                                  (RenderCom.tlb)
        Marshaling code                                 (RenderCom_p.c and dlldata.c)

RenderCom.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in RenderCom.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named RenderCom.pch and a precompiled types file named StdAfx.obj.
...
RenderComps.vcxproj
	...
	dlldata.c, RenderCom_i.c and RenderCom_p.c which are required
	to build the proxy/stub DLL.

RenderComps.vcxproj.filters
