...
typedef struct _RenderCom_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } RenderCom_MIDL_TYPE_FORMAT_STRING;

typedef struct _RenderCom_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } RenderCom_MIDL_PROC_FORMAT_STRING;

typedef struct _RenderCom_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } RenderCom_MIDL_EXPR_FORMAT_STRING;
...
extern const RenderCom_MIDL_TYPE_FORMAT_STRING RenderCom__MIDL_TypeFormatString;
extern const RenderCom_MIDL_PROC_FORMAT_STRING RenderCom__MIDL_ProcFormatString;
extern const RenderCom_MIDL_EXPR_FORMAT_STRING RenderCom__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IImageVolume_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IImageVolume_ProxyInfo;
...
static const RenderCom_MIDL_PROC_FORMAT_STRING RenderCom__MIDL_ProcFormatString =
    {
        0,
        {

	/* Procedure get_PixelSpacing */
...
/* 64 */	NdrFcShort( 0x422 ),	/* Type Offset=1058 */
...
/* 136 */	NdrFcShort( 0x422 ),	/* Type Offset=1058 */
...
static const RenderCom_MIDL_TYPE_FORMAT_STRING RenderCom__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* 1054 */	
			0x12, 0x0,	/* FC_UP */
/* 1056 */	NdrFcShort( 0xffde ),	/* Offset= -34 (1022) */
/* 1058 */	0xb4,		/* FC_USER_MARSHAL */
			0x83,		/* 131 */
/* 1060 */	NdrFcShort( 0x0 ),	/* 0 */
/* 1062 */	NdrFcShort( 0x4 ),	/* 4 */
/* 1064 */	NdrFcShort( 0x0 ),	/* 0 */
/* 1066 */	NdrFcShort( 0xfff0 ),	/* Offset= -16 (1050) */
...
/* Object interface: IImageVolume, ver. 0.0,
   GUID={0x860D3044,0x7914,0x4627,{0x94,0xD6,0xC9,0x9B,0xE7,0x1F,0xB1,0xA8}} */

#pragma code_seg(".orpc")
static const unsigned short IImageVolume_FormatStringOffsetTable[] =
    {
    0,
    36,
    72,
...
static const MIDL_STUBLESS_PROXY_INFO IImageVolume_ProxyInfo =
    {
    &Object_StubDesc,
    RenderCom__MIDL_ProcFormatString.Format,
    &IImageVolume_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IImageVolume_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    RenderCom__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(7) _IImageVolumeProxyVtbl = 
{
    &IImageVolume_ProxyInfo,
    &IID_IImageVolume,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IImageVolume::get_PixelSpacing */ ,
    (void *) (INT_PTR) -1 /* IImageVolume::put_PixelSpacing */ ,
    (void *) (INT_PTR) -1 /* IImageVolume::get_Buffer */ ,
    (void *) (INT_PTR) -1 /* IImageVolume::put_Buffer */
};

const CInterfaceStubVtbl _IImageVolumeStubVtbl =
{
    &IID_IImageVolume,
    &IImageVolume_ServerInfo,
    7,
    0, /* pure interpreted */
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    RenderCom__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _RenderCom_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IImageVolumeProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _RenderCom_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IImageVolumeStubVtbl,
    0
};

PCInterfaceName const _RenderCom_InterfaceNamesList[] = 
{
    "IImageVolume",
    0
};
...
#define _RenderCom_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _RenderCom, pIID, n)

int __stdcall _RenderCom_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_RenderCom_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo RenderCom_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _RenderCom_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _RenderCom_StubVtblList,
    (const PCInterfaceName * ) & _RenderCom_InterfaceNamesList,
    0, /* no delegation */
    & _RenderCom_IID_Lookup, 
    1,
    2,
